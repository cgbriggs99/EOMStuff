...
\begin{equation}
  \tilde{\left<ab\middle|ic\right>} = \left<ab\middle|ic\right> - \sum_mt_m^a\tilde{\left<mb\middle|ic\right>} - \sum_mt_m^b\left(\left<ma\middle|ci\right> + \sum_et_i^e\left<ma\middle|ce\right>\right) + \sum_et_i^e\left<ab\middle|ec\right>
\end{equation}
...
\begin{equation}
  \tilde{L}_{abic} = L_{abic} - \sum_mt_m^a\tilde{L}_{mbic} - \sum_mt_m^b\left(L_{maci} + \sum_et_i^eL_{mace}\right) + \sum_et_i^eL_{abec}
\end{equation}
